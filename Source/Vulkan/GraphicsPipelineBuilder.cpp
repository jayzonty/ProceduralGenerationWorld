...
GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetVertexBindingDescriptions(const std::vector<VkVertexInputBindingDescription> &descriptions)
{
...
GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetVertexAttributeDescriptions(const std::vector<VkVertexInputAttributeDescription> &descriptions)
{
...
GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetTopology(const VkPrimitiveTopology &topology)
{
    m_inputAssemblyCreateInfo.topology = topology;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetViewportCount(const uint32_t &viewportCount)
{
    m_viewportCreateInfo.viewportCount = viewportCount;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetViewports(const std::vector<VkViewport> &viewports)
{
...
GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetScissorCount(const uint32_t &scissorCount)
{
    m_viewportCreateInfo.scissorCount = scissorCount;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetScissors(const std::vector<VkRect2D> &scissors)
{
...
GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetPolygonMode(const VkPolygonMode &polygonMode)
{
    m_rasterizationCreateInfo.polygonMode = polygonMode;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetCullMode(const VkCullModeFlags &cullMode)
{
    m_rasterizationCreateInfo.cullMode = cullMode;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetFrontFace(const VkFrontFace &frontFace)
{
    m_rasterizationCreateInfo.frontFace = frontFace;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetDepthTestEnabled(const VkBool32 &flag)
{
    m_depthStencilCreateInfo.depthTestEnable = flag;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetDepthWriteEnabled(const VkBool32 &flag)
{
    m_depthStencilCreateInfo.depthWriteEnable = flag;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetDepthCompareOp(const VkCompareOp &compareOp)
{
    m_depthStencilCreateInfo.depthCompareOp = compareOp;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetDynamicStates(const std::vector<VkDynamicState> &dynamicStates)
{
...
GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetDescriptorSetLayouts(const std::vector<VkDescriptorSetLayout> &layouts)
{
...
GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetVertexShaderFilePath(const std::string &filePath)
{
    m_vertexShaderFilePath = filePath;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetFragmentShaderFilePath(const std::string &filePath)
{
    m_fragmentShaderFilePath = filePath;
    return *this;
}

GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetRenderPass(const VkRenderPass &renderPass)
{
...
VkPipelineLayout GraphicsPipelineBuilder::GetPipelineLayout()
{
    return m_pipelineLayout;
}

VkPipeline GraphicsPipelineBuilder::GetPipeline()
{
    return m_pipeline;
}
 ...
 */
bool GraphicsPipelineBuilder::CreateShaderModule(const std::string& shaderFilePath, VkDevice device, VkShaderModule& outShaderModule)
{
